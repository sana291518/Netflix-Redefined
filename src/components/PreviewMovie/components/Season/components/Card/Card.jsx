...
import { ReactComponent as PlayerIcon } from '/src/assets/icons/player.svg';
    ...
    <div className={styles.episodeCard} role="card">
      ...
      <div className={styles.episodeImage}>
        ...
        <Hide when={!!item.still_path}>
          <img
            src={BackError}
            alt={`${item.name} does not have a cover image`}
      ...
      <div className={styles.episodeDetails}>
        ...
        <Hide when={!!item.overview}>
          <p className={styles.info}>
            Oops... this episode does not have a synopsis.
          </p>
        </Hide>
      </div>
    </div>
